...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "56": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/435cubRAqNsFYKzyQHRRiHvR7oJjh828r5Aqe4cZC586",
  },
};
...
function transformMarketsToTags(chainId: string, markets: Market[]): ContractTag[] {
  ...
  return validTokens.map((token) => {
    ...
    return {
      ...
      "Project Name": "Kinza Finance",
      "UI/Website Link": "https://kinza.finance/",
      "Public Note": `Kinza Finance's official ${token.name} token contract.`,
    };
  });
}
